      ...
      <div className="grid lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-5">
          ...
          <p className="text-black text-justify">
            ...
            education and training.Our online learning platform is designed to
            be flexible, enabling you to fit your learning around your busy
            schedule. You can access the courses on any device, including
            desktop computers, tablet & mobile devices.
          </p>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="pl-5">
              ...
              <p className="text-black text-justify">
                Whether you are a busy professional, a stay-at-home parent, or a
                student who prefers to study from home effectively.
              </p>
            </div>
          </div>
          ...
          <div className="py-5">
            <Link
              href="/courses"
              className="bg-bluePrimary text-white py-3 px-6 transition-all duration-300 rounded hover:bg-cyanPrimary font-semibold"
            >
              {" "}
              Explore Courses{" "}
            </Link>
