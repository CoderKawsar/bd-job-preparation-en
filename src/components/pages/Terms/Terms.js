const Terms = () => {
  return (
    <div>
      ...
      <p>Welcome to BD Job Preparation!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of BD Job Preparation's Website, located at http://localhost:3000/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use BD Job Preparation if you do not
      ...
      <p>
        We employ the use of cookies. By accessing BD Job Preparation, you
        agreed to use cookies in agreement with the BD Job Preparation's Privacy
        Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, BD Job Preparation and/or its licensors own the
        intellectual property rights for all material on Easy Learning Platform.
        All intellectual property rights are reserved. You may access this from
        BD Job Preparation for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from BD Job Preparation</li>
        <li>Sell, rent or sub-license material from BD Job Preparation</li>
        <li>Reproduce, duplicate or copy material from BD Job Preparation</li>
        <li>Redistribute content from BD Job Preparation</li>
      </ul>
      ...
      <p>
        ...
        views and opinions of BD Job Preparation,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their
        views and opinions. To the extent permitted by applicable laws, BD Job
        Preparation shall not be liable for the Comments or for any liability,
      ...
      <p>
        BD Job Preparation reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant BD Job Preparation a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of BD Job Preparation; and (d) the
      ...
      <p>
        ...
        e-mail to BD Job Preparation. Please include your name, your
      ...
      <p>
        No use of BD Job Preparation's logo or other artwork will be allowed for
